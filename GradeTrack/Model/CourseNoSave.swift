...
//  GradeTrack
//
//  Created by Alexander Dawson on 2023-06-23.
//
...
class CourseNoSave {
    var name: String
    var grade: GradeNoSave?
    var breakdown: BreakdownNoSave?
    var assignments: [AssignmentNoSave]
    //var lastUpdate: Date
    ...
    init(name: String, lastUpdate: Date) {
        self.name = name
        self.grade = nil
        self.breakdown = nil
        self.assignments = []
